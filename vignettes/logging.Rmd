...
Logging is an excellent way to monitor the status of your data pipelines. Please consult the ['log4r' documentation ](https://cran.r-project.org/web/packages/log4r/log4r.pdf) for a comprehensive
